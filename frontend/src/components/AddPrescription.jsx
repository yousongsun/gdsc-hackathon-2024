    ...
    <>
      <div className='container p-4 mx-auto'>
        ...
        <div className='bg-white/80 rounded-3xl shadow-lg p-6 mt-4'>
          <h2 className='text-lg text-[#c0c0c0] font-bold mb-2'>Create a new prescription</h2>
          <div className='flex justify-between'>
            <h2 className='text-3xl font-bold mb-2'>Prescription Name</h2>
            <button className='bg-indigo-400 hover:bg-indigo-400 text-white font-bold py-1 px-4 rounded-3xl mt-4 '>Save changes</button>
          </div>
        </div>

        <div className='bg-white/80 rounded-3xl shadow-lg p-6 mt-4'>
          <h2 className='text-lg text-[#c0c0c0] font-bold mb-2'>Prescription details</h2>
